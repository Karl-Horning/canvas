...
export default function page() {
    return (
        <article>
            ...
            <CodeBlock>{`<p>Example assignment settings:</p>
<ul class="pill">
  <li>30% of module mark</li>
  <li>2 late submission rules</li>
  <li>10 points total</li>
...
<p>
  ...
  <span style="display: inline-block; margin: 0 0.25rem 0.25rem 0; padding: 0.15rem 0.5rem; border-radius: 999px; background: #eef4ff; color: #111322; font-size: 0.85rem;">
    10 points total
            ...
            <CodeBlock>{`<p>Example: module completion status</p>
<div id="progressbar"
...
<p>
  ...
  <strong>50% complete</strong>
            ...
            <CodeBlock>{`<p id="inline-progress-label">Reading progress:</p>
...
<p style="margin-top: 0.5rem">
  <strong>40% complete</strong> — 4 of 10 sections read.
            ...
            <CodeBlock>{`<!-- Example of semantic HTML, not supported in Canvas content -->
<label for="module-progress">Module completion:</label>
<progress id="module-progress" value="0.5" max="1">50%</progress>`}</CodeBlock>
            ...
            <ul>
                ...
                <li>
                    ...
                    <code>aria-valuenow</code>, and visible text are often more
                    robust and predictable than JavaScript-enhanced widgets.
                </li>
            </ul>
        </article>
    );
