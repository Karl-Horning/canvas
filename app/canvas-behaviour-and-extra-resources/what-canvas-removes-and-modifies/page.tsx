export default function page() {
    return (
        <article>
            ...
            <table className="w-full border-collapse mb-4 text-[0.95rem]">
                ...
                <tbody>
                    <tr>
                        <td className="border border-[#dddddd] p-2">
                            <code>&lt;script&gt;</code> and inline JavaScript
                        </td>
                        <td className="border border-[#dddddd] p-2">
                    ...
                    <tr>
                        ...
                        <td className="border border-[#dddddd] p-2">
                            Use inline styles on individual elements instead.
                            This course uses inline CSS for all layout and
                            spacing examples.
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td className="border border-[#dddddd] p-2">
                            Removed or heavily sanitised so that real HTML forms
                            are not available in normal course content.
                        </td>
                        <td className="border border-[#dddddd] p-2">
                            Use Canvas assignments, quizzes, or external tools
                            for collecting responses instead of hand-built
                            forms.
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td className="border border-[#dddddd] p-2">
                            Use styled links that look like buttons, and Canvas’
                            legacy progress bar or inline text descriptions
                    ...
                    <tr>
                        ...
                        <td className="border border-[#dddddd] p-2">
                            Class names remain in the HTML, but there is no way
                            to define new CSS for them inside the RCE.
                        </td>
                        <td className="border border-[#dddddd] p-2">
                            For predictable results, rely on inline styles and
                            the legacy Canvas classes documented in this course
                            (for example <code>btn</code>,<code>ic-Table</code>,
                    ...
                    <tr>
                        <td className="border border-[#dddddd] p-2">
                            <code>name</code> on <code>&lt;details&gt;</code>
                        </td>
                        <td className="border border-[#dddddd] p-2">
                            Attribute
                        </td>
                        <td className="border border-[#dddddd] p-2">
                            ...
                            saved, so browser “exclusive accordion” behaviour is
                            not available.
                        </td>
                        <td className="border border-[#dddddd] p-2">
                    ...
                    <tr>
                        ...
                        <td className="border border-[#dddddd] p-2">
                            ...
                            Check layouts again after saving.
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td className="border border-[#dddddd] p-2">
                            Still recognised in this instance. Tabs, popovers,
                            tooltips, draggable items, sortable lists and
                            resizable boxes work when marked up correctly.
                        </td>
                        <td className="border border-[#dddddd] p-2">
                            These are legacy features and behaviour may change
                            in future updates. Use them for optional
